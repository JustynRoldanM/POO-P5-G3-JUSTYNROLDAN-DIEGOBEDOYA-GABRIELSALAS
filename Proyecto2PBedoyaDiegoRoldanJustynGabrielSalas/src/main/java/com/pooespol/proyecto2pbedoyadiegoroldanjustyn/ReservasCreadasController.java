    ...
    public void actualizarReservas() {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("src/main/resources/files/reservas.txt"))) {
            ...
            while ((linea = br.readLine()) != null) {
                ...
                Vuelo vRegreso = VuelosRegresoController.buscarVueloa(info[8]);
                ...
                Reserva r = new Reserva(info[0], c, vIda, vRegreso, Integer.valueOf(info[6]), tIda, tRegreso,info[4],info[5],vIda.getPrecioVuelo()+vRegreso.getPrecioVuelo());
