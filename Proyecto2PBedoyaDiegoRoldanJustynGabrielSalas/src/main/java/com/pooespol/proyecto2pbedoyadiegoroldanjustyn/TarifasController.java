...
public class TarifasController implements Initializable {
    ...
    public void cargarContenidoDinamico() {
        ...
        for (Tarifa t : tarifas) {
            ...
            Label lb1 = new Label(t.getDescripcion() + ": " + t.getNombreTarifa());
            ...
            Label lbl3 = new Label(String.valueOf(v.getPrecioVuelo() + v.getPrecioVuelo() * t.getIncremento()));
   ...
   public static void cargarTarifas(){
        try(BufferedReader br = new BufferedReader(new FileReader("src/main/resources/files/tarifas.txt"))){
            ...
            while(linea!=null){
                ...
                tarifas.add(new Tarifa(datos[0],datos[1],Double.parseDouble(datos[3]),caract));
                linea = br.readLine(); 
            }
